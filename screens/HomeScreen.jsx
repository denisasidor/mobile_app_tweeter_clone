        ...
        <View style={styles.tweetContainer}>
            ...
            <View style={{ flex: 1 }}>
                <TouchableOpacity style={styles.flexRow} onPress={() => gotoSingleTweet()}>
                    ...
                    <Text numberOfLines={1} style={styles.tweetHandle}>@denisasidor</Text>
                    <Text>&middot;</Text>
                ...
                <TouchableOpacity style={styles.tweetContentContainer} onPress={() => gotoSingleTweet()}>
                    <Text style={styles.tweetContent}>
                        ...
                        Cupiditate error facere temporibus perspiciatis, in unde.
                        Ipsam, minima, voluptates, recusandae dolorum alias soluta ullam illum doloremque et eaque officia sunt quisquam?
                    </Text>
                </TouchableOpacity>
